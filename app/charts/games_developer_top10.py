...
def create_games_developer_top10(df):

    games_per_developer = df['developer'].value_counts().head(10)

    fig, ax = plt.subplots(figsize=(10, 6))
    games_per_developer.sort_values().plot(kind='barh', color='lightgreen', edgecolor='black')
    ax.set_title('Número de Jogos por Desenvolvedora (Top 10)', fontsize=16)
