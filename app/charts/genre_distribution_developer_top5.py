...
def create_genre_distribution_developer_top5(df):
    ...
    top_developers = developer_game_counts.nlargest(5).index  # Top 10 desenvolvedores com mais jogos
    ...
    ax.set_title('Distribuição de Gêneros por Desenvolvedor (Top 5)', fontsize=16)
